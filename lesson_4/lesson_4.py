...
path, vyrab, stavka, prem = argv
result = (int(vyrab) * int(stavka)) +  int(prem)
print('ЗП = ', result)
...
spis = [3 ,453,454, 4, 435, 5, 12, 1, 4456, 8, 17, 25, 99]
new = [spis[i] for i  in range(1,len(spis),1) if spis[i] > spis[i-1]]
print(new)
...
spis_2021 = [i for i in range(20, 200) if i % 20 ==0 or i % 21 == 0]
print(spis_2021)
...
obrazecz = [2, 4, 4, 1,567, 12, 229, 11,1, 10, 8,67, 14, 12, 3, 12]
#print(obrazecz.count(obrazecz[5]))
res_spis = [obrazecz[i] for i in range(0, len(obrazecz),1) if obrazecz.count(obrazecz[i]) <= 1]
print(res_spis)
...
spis_5 = [i for i in range(100,1000,1) if i % 2 == 0]
#print(spis_5)
my_summa = reduce(my_func, spis_5)
print('Результат = ',my_summa * 1000)
#print(reduce(my_func, spis_5))
